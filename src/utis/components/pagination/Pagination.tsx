...
}: any) =>
{
    ...
    return(
        ...
        <ul className="pagination">
         ...
         {pages.length > 1 && <a>
            <img style={{width:"50px",height:"50px"}} onClick={()=>{decreasePage()}} src={require(`./../../../assets/imgs/left.png`)}/>
          </a>}
          ...
          {pages.length > 1 && <a>
            <img style={{width:"50px",height:"50px"}} onClick={()=>{increasePage()}} src={require(`./../../../assets/imgs/right.png`)}/>
          </a>}
